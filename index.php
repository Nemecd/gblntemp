...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>GOSPEL LOVE BELIEVERS NETWORK</title>
...
<body id="top">
    ...
    <header class="s-header">
        ...
        <nav class="header-nav-wrap">
            <ul class="header-nav">
                ...
                <li><a href="forn/index.html" title="Ambassador Portal">Registration</a></li>
            </ul>
        </nav>
    ...
    <!-- hero
    ================================================== -->
    <section class="s-hero" data-parallax="scroll" data-image-src="images/1.jpg" data-natural-width=3000
    ...
    <section id="about" class="s-about">
        ...
        <div class="row row-y-center about-content">
            ...
            <div class="column large-half medium-full">
                ...
                <a href="about.html" class="btn btn--primary btn--about">More About GLBN</a>
            </div>
    ...
    <footer class="s-footer">
        ...
        <div class="row footer-bottom">
            <div class="column ss-copyright">
                <span>© Copyright GLBN 2024</span>
                <span>Design by <a href="">Valid Tech</a></span>
            </div>
        </div> <!-- footer-bottom -->
